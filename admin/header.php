			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item dropdown">
						...
						<a class="nav-link" href="index.php"><i class="fa fa-home"></i> Donation</a>
					<a class="nav-link" href="Donors.php"><i class="fa fa-home"></i> Donors</a>
					<a class="nav-link" href="message.php"><i class="fa fa-home"></i> Messages</a>
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="nav-item">
							<a class = "nav-link" href="#">
								...
								{
								echo "<a class = 'nav-link' href='logout.php'>Log Out Here</a>";
										}
										?>
									</a>
								</li>
